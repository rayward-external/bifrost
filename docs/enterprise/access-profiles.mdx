...
<Info>
  ...
  **Access Profiles** section of the [API Reference](/api-reference/overview).
</Info>
...
For programmatic configuration (every endpoint, body shape, and error code), see the **Access Profiles** section of the [API Reference](/api-reference/overview).

---

## What you can configure

A profile carries the following pieces of policy. Use the UI walkthrough above for guidance and see the [API Reference](/api-reference/overview) for exact field shapes.
