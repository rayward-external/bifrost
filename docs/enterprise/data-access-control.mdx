...
<Info>
  ...
  Reference](/api-reference/overview). All role and permission endpoints are tagged **RBAC**.
</Info>
...
For programmatic configuration (create role, update scope, assign role to user, manage permissions), see the **RBAC** endpoints in the [API Reference](/api-reference/overview).
