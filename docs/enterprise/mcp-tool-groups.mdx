...
<Info>
  ...
  Tool Groups** section of the [API Reference](/api-reference/overview).
</Info>
...
For programmatic configuration (every endpoint, body shape, and error code), see the **MCP Tool Groups** section of the [API Reference](/api-reference/overview).
