...
<Frame caption="The Provisioning source setting in the provider configuration - choose between SCIM and login claims (default) or SCIM only.">
  <img src="/media/user-provisioning/scim-provisioning-source.png" alt="Provisioning source dropdown showing SCIM and login claims (default) and SCIM only - ignore login claims options" />
</Frame>
