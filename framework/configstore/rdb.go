...
func (s *RDBConfigStore) UpdateClientConfig(ctx context.Context, config *ClientConfig) error {
	dbConfig := tables.TableClientConfig{
		...
		UnknownBatchIDPolicy:                  config.UnknownBatchIDPolicy,
		BatchAdminVirtualKeyIDs:               config.BatchAdminVirtualKeyIDs,
...
func (s *RDBConfigStore) GetClientConfig(ctx context.Context) (*ClientConfig, error) {
	...
	return &ClientConfig{
		...
		UnknownBatchIDPolicy:                  dbConfig.UnknownBatchIDPolicy,
		BatchAdminVirtualKeyIDs:               dbConfig.BatchAdminVirtualKeyIDs,
