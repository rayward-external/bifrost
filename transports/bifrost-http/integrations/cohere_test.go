...
func TestCohereRerankRouteRequestConverter(t *testing.T) {
	...
	// The Cohere rerank converter falls back to the Cohere provider for an
	// unprefixed model string (fork patch — see core/providers/cohere/rerank.go
	// and PR #117 "Cohere fallback").
